                        ...
                        <ul class="nav navbar-nav">
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="<c:url value='/static/images/instructor.png'/>" class="user-image" alt="Instructor Image">
                                    <span class="hidden-xs">Wykładowca</span>
                                </a>
                                <ul class="dropdown-menu">
                                    <li class="user-header">
                                        <img src="<c:url value='/static/images/instructor.png'/>" class="img-circle" alt="Instructor Image">
                                        <p>Wykładowca</p>
                                    </li>
