                        ...
                        <div class="col-xs-6">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Nowy Student</h3>
                                </div>

                                <form role="form" method="post" action="<c:url value='/admin/student/create'/>" autocomplete="off">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="album" name="album" type="text" class="form-control" value="">
                                        </div>
