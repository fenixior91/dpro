...
public class InstructorDBUtil {
    ...
    public static final String SQL_FIND_BY_ID_QUERY
            = String.format(SQL_FIND_BY_ID_PATTERN, UserDBUtil.ID_COLUMN, InstructorDBUtil.ID_COLUMN, UserDBUtil.ID_COLUMN);
    ...
    public static final String SQL_FIND_ALL_QUERY
            = String.format(SQL_FIND_ALL_PATTERN, UserDBUtil.ID_COLUMN, InstructorDBUtil.ID_COLUMN);
    ...
    public static final String SQL_INSERT_INSTRUCTOR_QUERY
            = String.format(SQL_INSERT_INSTRUCTOR_PATTERN, InstructorDBUtil.SCIENCE_DEGREE_COLUMN, InstructorDBUtil.ID_COLUMN, InstructorDBUtil.ID_COLUMN);
    ...
    public static final String SQL_UPDATE_INSTRUCTOR_QUERY
            = String.format(SQL_UPDATE_INSTRUCTOR_PATTERN, InstructorDBUtil.SCIENCE_DEGREE_COLUMN, InstructorDBUtil.ID_COLUMN);
    ...
    public static Instructor generate(ResultSet rs) throws SQLException {
        ...
        instructor.setEmail(rs.getString(UserDBUtil.ENABLED_COLUMN));
        ...
        instructor.setId(rs.getLong(ID_COLUMN));
